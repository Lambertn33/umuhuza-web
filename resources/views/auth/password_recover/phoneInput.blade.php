                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="auth-content my-auto">
                                        <div class="text-center">
                                            ...
                                            <p class="text-muted mt-2">Enter Your Phone Number to continue</p>
                                        </div>
                                        ...
                                        @endif
                                        <form class="mt-4 pt-2" action="{{route('providePhoneForPasswordReset')}}" method="POST">
                                            @csrf
                                            <div class="form-floating form-floating-custom mb-4">
                                                <input type="tel" class="form-control" id="input-tel" value="{{old('telephone')}}" maxlength="12" minlength="12" name="telephone" placeholder="Enter Telephone" required>
